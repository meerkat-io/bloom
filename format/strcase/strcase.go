...
// SnakeCase : convert argument to snake_case style string.
...
// CamelCase : convert argument to camelCase style string
...
// PascalCase : convert argument to PascalCase style string
